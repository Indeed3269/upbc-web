# Script para actualizar la información de las carreras con codificación UTF-8 correcta
...
foreach ($carrera in $carrerasFolders) {
    ...
    if (Test-Path $htmlFile) {
        ...
        # También eliminar la sección de Laboratorios especializados
        $content = $content -replace '<div class="carrera-info-box">\s*<h4>Laboratorios especializados</h4>[\s\S]*?</ul>\s*</div>', ''
